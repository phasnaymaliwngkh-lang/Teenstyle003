...
สถานะปัจจุบัน: **STEP 1–29 เสร็จแล้ว** — ครบวงจรทั้งฝั่งลูกค้าและร้าน:
...
ขอบเขตตอนนี้เฉพาะฟังก์ชันล้วนใน `src/lib` ที่ไม่ต้องมี DOM · `npm test` รันทั้ง backend และ frontend
