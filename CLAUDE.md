...
สถานะปัจจุบัน: **STEP 1–26 เสร็จแล้ว** — ครบวงจรทั้งฝั่งลูกค้าและร้าน:
...
→ **หลังบ้าน: ภาพรวมร้าน + รายงานยอดขาย + จัดการคำสั่งซื้อ + จัดการสินค้า + คลังสินค้า + แจ้งเตือนสต็อก + บาร์โค้ด/QR + นำเข้า/ส่งออก (CSV, Excel) + ตรวจรีวิว + จัดการลูกค้า**
