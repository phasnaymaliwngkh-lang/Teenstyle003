...
- **ยังไม่มีหน้าสำหรับบทความคลังความรู้รายชิ้น** (เปิดอ่านใน modal ของ `/faq`) จึงไม่มี URL
  ให้ส่งเข้า sitemap — เนื้อหาที่ควรติดอันดับที่สุดยังไม่มีที่อยู่ของตัวเอง (งานของ STEP 45/49)
...
· ผลล่าสุด **30 เส้นทาง อยู่ในงบทั้งหมด** · ตัวเลขก่อน/หลังทั้งหมดอยู่ใน [docs/10-performance.md](docs/10-performance.md)
...
· `UPDATE viewCount + 1` ทุกครั้งที่เปิดหน้าสินค้าเป็นการเขียนในเส้นทางอ่าน (4.5ms + row lock)
→ ต้องรวมยอดเป็นชุดตอน STEP 46
