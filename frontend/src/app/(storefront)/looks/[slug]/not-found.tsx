...
/**
 * แสดงเมื่อ slug ของลุคไม่มีในฐานข้อมูล (backend ตอบ 404)
 * ไม่ใช่ error state — จึงไม่มีปุ่มลองใหม่ แต่ให้ทางไปต่อ
 */
export default function LookNotFound() {
  return (
    <div className="mx-auto max-w-lg px-4 py-20 text-center">
      <SearchX className="mx-auto size-12 text-brand-soft" aria-hidden />
      <h1 className="mt-4 text-2xl">ไม่พบลุคนี้</h1>
      <p className="mt-2 text-sm text-muted">
        ลุคนี้อาจถูกนำออกไปแล้ว หรือลิงก์ที่ใช้ไม่ถูกต้อง ลองดูไอเดียอื่นได้เลย
      </p>
